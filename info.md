...
| `basemap`      | string  | `swisstopo-grey` | Base map shown on load: `swisstopo-grey`, `swisstopo-color`, `swisstopo-aerial` or `dark`. Viewers can switch from the control on the map. |
